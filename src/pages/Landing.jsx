...
import { ChevronRight, Star, Award, Heart, Gift, ShoppingBag, Instagram, Facebook, Twitter, Menu, X } from "lucide-react";
            ...
            {bestSellers.map((product, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4 md:p-6">
                  <h3 className="text-lg md:text-xl font-semibold mb-2 text-amber-800">{product.name}</h3>
                  <p className="text-gray-700 mb-4 text-sm md:text-base">{product.description}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {testimonials.map((testimonial, index) => (
              <div key={index} className="bg-amber-50 p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-700 mb-3 md:mb-4 italic text-sm md:text-base">"{testimonial.quote}"</p>
                <p className="font-semibold text-amber-800 text-sm md:text-base">{testimonial.name}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-3 md:gap-4">
            <input
              ...
              className="px-4 py-2 md:py-3 rounded-lg flex-grow text-gray-900 focus:outline-none focus:ring-2 focus:ring-amber-500 text-sm md:text-base"
            />
